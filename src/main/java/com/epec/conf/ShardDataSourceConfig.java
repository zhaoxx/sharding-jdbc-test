...
import com.epec.sharding.ModuloDatabaseShardingAlgorithm;
import com.epec.sharding.ModuloTableShardingAlgorithm;
	...
	private ShardingRule shardingRule() throws SQLException {
		ShardingRule shardingRule = ShardingRule.builder().dataSourceRule(dataSourceRule())
				...
				.databaseShardingStrategy(
						new DatabaseShardingStrategy("buyer_id", new ModuloDatabaseShardingAlgorithm()))
